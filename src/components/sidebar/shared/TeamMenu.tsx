      ...
      >
        ...
        <div className="px-4 py-2">
          ...
          {teams.map((team) => {
            ...
            const teamIconColors = useIconColors(isSelected);
            ...
            return (
              <button
                ...
                style={{ 
                  color: teamIconColors.color,
                  backgroundColor: isSelected ? `${currentTheme.colors.primary}20` : 'transparent',
                  transition: 'all 0.2s ease-in-out'
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.color = teamIconColors.hoverColor;
                  e.currentTarget.style.backgroundColor = isSelected 
                    ? `${currentTheme.colors.primary}30` 
                    : `${currentTheme.colors.primary}10`;
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.color = teamIconColors.color;
                  e.currentTarget.style.backgroundColor = isSelected 
